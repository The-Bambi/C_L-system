...
/*
    Porusza zolwiem bez rysowania i sprawdzania czy jest poza obszarem - sluzy do szacowania
*/
void turtle_calculate_foward(int pixels);
...
/*
    Szacowanie bez sprawdzania granic
*/
